...
const IntroductionSection = () => {
  return (
    <div className="w-full px-6 sm:px-8 py-16 flex flex-col items-center bg-[#101111] rounded-b-4xl">
      {/* container max-w */}
      <div className="w-full max-w-7xl flex flex-col gap-16">
        {/* Header */}
        <div className="w-full flex flex-col lg:flex-row items-start justify-between gap-8">
          <h2 className="text-4xl md:text-5xl lg:text-7xl">Meet the Punks</h2>
